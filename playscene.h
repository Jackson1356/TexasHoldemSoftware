...
public:
    ...
    void PlayerImg(QLabel *a,int x);
    void Fly(QLabel *a,int x,int y);
    void Turn(QLabel*a,QString card);
    void PlayerImg_2(QLabel * a,int x);
    void PlayerImg_3(int x,int i);
    void PlayerImg_4(QLabel * a,int i);
    MyQPushButton*fold;                                            //放弃按钮
    MyQPushButton*follow;                                          //跟注按钮
    MyQPushButton*confirm;                                         //确认按钮
    MyQPushButton*add;                                             //加注按钮
    QPropertyAnimation * deal;                                     //发牌动画
    QPropertyAnimation * chip;                                     //扔筹码动画
